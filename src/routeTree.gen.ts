...
// It is kept in sync here so the project remains type-complete in exported source archives.
...
const ReparacaoComputadoresBragaRoute = ReparacaoComputadoresBragaRouteImport.update({
